...
<?php $__env->startSection('title', 'IDLe FAQ'); ?>
...
<?php $__env->startSection('content'); ?>
   ...
   <div class="card" style="margin-top: 10px;" id="tanya">
       <div class="card-body">
           ...
           <form class="" action="<?php echo e(route('faq.ask')); ?>" method="post" autocomplete="off" target="_blank">
             <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idlefasi1/laravel/resources/views/pages/faq.blade.php ENDPATH**/ ?>