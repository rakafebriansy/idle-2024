...
<?php $__env->startSection('app-title', 'Tambah Peserta Final ' . $kategori->kategori); ?>
        ...
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-title-w-btn">
                    <h3 class="title">Tambah Peserta <?php echo e($kategori->nama_kategori); ?> Tahap Final</h3>
                </div>

                <div class="tile-body">
                    <form action="<?php echo e(route('admin.final.store', ['kategori' => $kategori->kategori ])); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idlefasi1/laravel/resources/views/admin/pages/add_final.blade.php ENDPATH**/ ?>